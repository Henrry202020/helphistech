		...
		<>
			...
			<main className={darkMode ? 'bg-black text-zinc-200' : 'bg-white text-black'}>
				<div className={`${darkMode ? 'bg-hero-dark' : 'bg-hero-light'}`} id="hero">
					<Navbar />
					<section className="flex items-center justify-center xl:px-20 2xl:px-0 min-h-[80rem] xl:min-h-[50rem] lazy-load-1" style={{height: 'calc(100vh - 5rem)'}}>
							...
							<div className="flex flex-col gap-20">
								<div className="flex flex-col gap-5 relative">
									<div className="flex flex-col">
										<h4 className={`uppercase font-semibold ${darkMode ? 'subtitle-dark' : 'subtitle-light'}`}>Unsere Dienstleistungen</h4>
									</div>
