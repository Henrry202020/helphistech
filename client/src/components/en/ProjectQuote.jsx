        ...
        >
            {({ errors, touched }) => (   
                <Form className="flex flex-col gap-6">
                    ...
                    <button className={`py-2 px-4 bg-gradient rounded-xl text-lg uppercase font-bold text-center cursor-pointer ${!projectQuoteAnimation ? 'lazy-load-4 block' : 'hidden'}`}>Submit</button>
                </Form>
            )}
        </Formik>
    )
